...
LastEditor: JiangJi
LastEditTime: 2024-01-25 10:10:13
Discription: 
'''
import torch
...
class Policy(BasePolicy):
    ...
    def learn(self, **kwargs): 
        ...
        old_log_probs = torch.tensor(np.array(old_log_probs), device=self.device, dtype=torch.float32).unsqueeze(dim=1) # shape:[batch_size,1]
        # convert to tensor
