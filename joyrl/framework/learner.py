...
LastEditor: JiangJi
LastEditTime: 2024-05-30 18:02:27
Discription: 
'''
import ray
import copy
    ...
    def run(self):
        ...
        while True:
            ...
            if training_data is not None:
                ...
                exec_method(self.tracker, 'pub_msg', 'get', Msg(type = MsgType.TRACKER_INCREASE_UPDATE_STEP))
                ...
                if global_update_step % self.cfg.policy_summary_fre == 0:
                    ...
                    exec_method(self.recorder, 'pub_msg', 'remote', Msg(type = MsgType.RECORDER_PUT_SUMMARY, data = policy_summary))
            run_step += 1
